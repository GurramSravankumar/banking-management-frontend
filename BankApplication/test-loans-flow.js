...
async function runLoanTests() {
    ...
    try {
        ...
        const accRes = await axios.get(`${BASE_URL}/api/user/profile`, { headers });
        const myAccsRes = await axios.get(`${BASE_URL}/api/user/accounts`, { headers });
        const accounts = myAccsRes.data;
